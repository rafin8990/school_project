...
<div class="flex justify-end">
    ...
    <div class="my-5  mx-5 w-[150px] font-bold">
        ...
        <input class="hidden" value="{{  $student->last_name }}" type="text" name="last_name[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->class }}" type="text" name="class"
            id="">
        ...
        <input class="hidden" value="{{ $student->schoolCode}}" type="text" name="school_code"
            id="">
            <input class="hidden" value="{{  $student->birth_date }}" type="text" name="birth_date[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{  $student->year }}" type="text" name="year]"
            id="">
        <input class="hidden" value="{{  $student->gender }}" type="text" name="gender[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->image }}" type="text" name="image[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->present_address }}" type="text" name="present_address[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->present_street}}" type="text" name="present_street[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{  $student->present_city }}" type="text" name="present_city][{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{  $student->present_country }}" type="text" name="present_country[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->present_zip_code }}" type="text" name="present_zip_code[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->parmanet_address }}" type="text" name="parmanet_address[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->parmanet_street}}" type="text" name="parmanet_street[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{  $student->parmanet_country }}" type="text" name="parmanet_country][{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{  $student->parmanet_city }}" type="text" name="parmanet_city[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->parmanent_zip_code }}" type="text" name="parmanent_zip_code[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->email }}" type="text" name="email[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->PhoneNumber}}" type="text" name="PhoneNumber[{{  $student->student_id }}]"
            id="">
        <input class="hidden" value="{{ $student->password}}" type="text" name="password[{{  $student->student_id }}]"
            id="">
