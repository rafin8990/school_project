...
<div class="overflow-x-auto mt-10 md:mx-5">
    <h2 class="text-3xl text-center mb-10 font-bold">Customer Care</h2>
    <table class="table border-2 ">
        ...
        <tbody>
            ...
            <tr>
                @if ($admin->role == 'super_admin' || $admin->role == 'admin_one' || $admin->role == 'executive' ||
                $admin->role == 'admin_two' || $admin->role == 'data_entry_operator')
