<div class="drawer-side">
    ...
    <div tabindex="4" class="collapse collapse-plus bg-blue-950   mb-2 text-white">
            ...
            <div class="collapse-content">
                <ul>
                    <li class="bg-white text-black rounded-xl "><a href="/allAdmin/{{$schoolCode}}"> All Admins</a></li>
        ...
        <div tabindex="4" class="collapse collapse-plus bg-blue-950 bg-accent  mb-2 text-white">
            ...
            <div class="collapse-content">
                <ul>
                    ...
                    <li class="bg-white text-black rounded-xl mt-2"><a href="/update-attendence">Update Attendence</a>
                    </li>
                </ul>
                  
            </div>
        ...
        <div tabindex="4" class="collapse collapse-plus bg-blue-950 bg-accent  mb-2 text-white">
            ...
            <div class="collapse-content">
                <ul>
                    ...
                    <li class="bg-white text-black rounded-xl mt-2"><a href="/fees-collection">Fees Collection</a></li>
                </ul>
                  
            </div>
        </div>
